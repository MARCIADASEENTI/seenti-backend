...
import time
# Importação corrigida para evitar erro de sintaxe
import sys
sys.path.append('/home/marcia/seenti_app')
from jwt_integration.middleware.jwt_middleware import rate_limit_check
...
def jwt_logout():
    ...
    try:
        ...
        if jti:
            ...
            print(f"🔒 TOKEN INVALIDADO: {jti}")
        
        # Força a expiração do token atual
